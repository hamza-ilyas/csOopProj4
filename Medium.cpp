 ...
 **
 **
 ** This file is the implementation of the corresponding Medium.h file.
 **
...
Medium::Medium()          { /* Intentionally left blank */ }
...
int Medium::attack(string enemyName, int attackersHealth){

  cout << "The medium warhorse " << getName() << " attacks " <<  enemyName;
